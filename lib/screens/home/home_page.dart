          ...
          child:
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    InProgressCard(num: personalData.workoutInProgress.length),
                    TimeCard(
            ...
            Row(
              ...
              children: [
                HomeCard(
                  ...
                  exercices: workouts[workouts.length - 2].exercices.length,
                  minutes: workouts[workouts.length - 2].totalMinutes,
                  name: workouts[workouts.length - 2].name,
                ),
                HomeCard(
                  imageUrl:
                      'assets/images/${workouts[workouts.length - 1].imageName}',
                  exercices: workouts[workouts.length - 1].exercices.length,
                  minutes: workouts[workouts.length - 1].totalMinutes,
